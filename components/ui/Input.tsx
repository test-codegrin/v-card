...
// Floating label input with shared motion/focus rules so it can be reused across panels.
const Input = React.forwardRef<HTMLInputElement, InputProps>(function Input(
  ...
  return (
    <div className={clsx('w-full space-y-1 text-sm font-medium', tone === 'dark' ? 'text-white/80' : 'text-secondary/80')}>
      <div
        className={clsx(
          'relative rounded-xl border px-4 pb-2 pt-5 transition focus-within:-translate-y-[1px] focus-within:shadow-card-hover',
          toneClasses[tone],
